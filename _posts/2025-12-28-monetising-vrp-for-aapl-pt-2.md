...
date: 2025-12-28
excerpt: "We examine the risks associated with the naked put strategy developed in Part I to monetise VRP of AAPL. We observe negative skewness (−1.53) and excess kurtosis (2.30) in the distribution of the PnL. The VaR estimates at 95% and 99% CL are USD 677.85 and USD 1,025.91 respectively, while the corresponding ES estimates are USD 938.38 and USD 1139.38 conditional on the losses exceeding the respective VaR thresholds. We assess that the tail risks stem primarily from exposure of short naked puts to delta and gamma risks."
---
